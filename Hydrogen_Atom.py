...
class Hydrogen_Atom(object):
    ...
    def get_energy_levels(self,number_of_levels):
        """
        Function used to get the first two eigenvalues of the hamiltonian which correspond to the Energy levels of the system.
        """
        vals, vecs = splinalg.eigsh(self.hamiltonian_operator(), k=number_of_levels,which= 'SA')
        print(vals)
    ...
    def get_error(self):
        ...
        """
        e_calc_one,e_calc_two = self.get_energy_levels(2)
    ...
    def calculate_energy_levels_super(self,number_of_levels):
        """
        ...
        vals = linalg.eigvalsh_tridiagonal(diagonal_main,diagonal_off,select='i',select_range=(0,number_of_levels-1))
